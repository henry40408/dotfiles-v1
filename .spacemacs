...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(editorconfig keyfreq)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Source Code Pro for Powerline Light"
                               :size 18
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
